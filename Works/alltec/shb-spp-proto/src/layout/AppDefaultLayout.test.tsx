...
import Icon, { QuestionCircleOutlined, StarFilled } from "@ant-design/icons";
            ...
            <div role="main" id="Main" className="role-main">
              <div className="nodes" data-node-no="0">
                <div className="div-header">
                  <div className="prime">
                    <SppBreadcrumb itemsArray={['조회사유 등록/결재', '등록', '전일조회 사유등록']} />
                    ...
                    <div className="m-title">
                      ...
                      <div className="utile _user">
                        <div className="favorite">
                          <SppButton color="default" variant="text" icon={<StarFilled />} title="즐겨찾기 등록"></SppButton>
                        </div>
