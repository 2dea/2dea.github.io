        ...
        callback: function() {
            $(document)
                .on('change', '.FN_selectToggle', function(evt) {
                    ...
                    $('.FN_selectToggle-item[data-fn-toggle-name="' + match + '"]')
                        .hide()
                        .eq(index)
                            .show()
                    ;
        ...
        create: function() {
            $('.FN_datepicker')
                .each(function(idx) {
                    ...
                    var _name = $date.attr('data-fn-date-name');
                    var _range = $date.attr('data-fn-date-range');
                    var _min = $date.attr('data-fn-date-min');
                    var _max = $date.attr('data-fn-date-max');
                    ...
                    try {
                        $date
                            .AbDatepicker({
                                ...
                                next: ( _range === 'start' ) ? '[data-fn-date-name="' + _name + '"][data-fn-date-range="end"]' : null,
                                previous: ( _range === 'end' ) ? '[data-fn-date-name="' + _name + '"][data-fn-date-range="start"]' : null,
                                min: ( _min ) ? _min : null,
                                max: ( _max ) ? _max : null,
                                modal: true,
