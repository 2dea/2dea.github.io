/**
 * @description 자금현수송 > 외화현수송 > 외화시재 및 보유현황
 */
...
function FMTFT1301M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '자금현수송' }, { label: '외화현수송' }, { label: '외화시재 및 보유현황' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">외화시재 및 보유현황</span>
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">부점별 외화 보유현황</span></h2>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">보유일자</span></div></th>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">보유한도</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">보유금액</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">부족액/잉여액</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">신청구분</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">신청금액</span></div></th>
                          </tr>
                        </thead>
                          ...
                          {[...Array(24)].map((e, idx) => (
                            <>
                              ...
                              <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>
                                ...
                                {
                                  (idx) % 3 === 0 &&
                                  <>0801</>/* 그리드 로우그룹/rowspan 최상위 셀만 데이터 출력 { @DEV } */
                                }
                                </td>
                                <td className="p-x-cell-span">{/* 그리드 로우그룹/rowspan 'p-x-cell-span' 클래스네임 추가 필요(border 숨김) { @DEV } */}
                                {
                                ...
                                <td className="g-end">-40,000(부족)</td>
                                <td>미신청</td>
                                <td className="g-end">30,000</td>
                              </tr>
                            {
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">외화보유현황 총계</span></h2>
