          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">계약현황</span>
                          ...
                          <td colSpan={3}>
                            <div className="m-mixed-field">
                              ...
                              <div className="m-checks">
                                <InputRadio name="RADIO:T_10" label="Y" />
                                <InputRadio name="RADIO:T_10" label="N" />
                              </div>
