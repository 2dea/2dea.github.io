/**
 * @description 자금현수송 > 외화현수송 > 타행수출입신청관리
 */
...
function FMTFT1101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '자금현수송' }, { label: '외화현수송' }, { label: '타행수출입신청관리' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">타행수출입신청관리</span>
            ...
            <div className="m-binds type-end">
              <div className="group _utility">
                <div className="m-print-binds">
                  ...
                  <CommonButton label="INVOICE출력" className="_texted" />
                          ...
                          {[...Array(24)].map((e, idx) => (
                            <>
                              <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>
                                ...
                                <td>결재요청</td>
                                <td><span className="o-digit type-date">2025-12-25</span></td>
                                <td className="g-start">BRINKS GLOBAL</td>
                    ...
                    <div className="column">
                      ...
                      <div className="o-section">
                        <div className="m-header">
                          ...
                          <div className="m-binds">
                            <div className="group">
                              <CommonButton label="웹단말 수입송금" className="_solid-primary" />
                            </div>
                          </div>
                        </div>
                ...
                <TabPanel className="m-tabs-panel react-tabs__tab-panel">
                  ...
                  <div className="o-grid">
                    <div className="column">
                      ...
                      <div className="o-section">
                        <div className="m-header">
                          <h3 className="o-heading level3"><span className="label">자금현송명령부</span></h3>
                            ...
                            <table className="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td colSpan={1}><span className="o-digit type-date">2025-12</span></td>
                                  <th colSpan={1}>
