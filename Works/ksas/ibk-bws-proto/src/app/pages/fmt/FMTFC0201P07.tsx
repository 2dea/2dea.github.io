/**
 * @description 자금현수송 > 외화정사 > 인수도관리 ~ (LP)인도취소(정사분)
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">인도취소(정사분)</span></h3>}
      >
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`비고(사유)`} require={false} />
                          </th>
                          <td colSpan={1}>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)인도취소(정사분) [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
