/**
 * @description 자금현수송 > 원화현수송 > 원화현수송신청관리 ~ (LP)신청내역수정
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">신청내역수정</span></h3>}
      >
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)신청내역수정 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
