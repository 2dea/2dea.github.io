/**
 * @description 자금현수송 > 외화현수송 > 지점간외화현수송신청관리 ~ (LP)자금신청
 */
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)자금신청 [wdth-70p(w1340)]</span>
            </h1>
          </div>
        </div>

        {/* <!-- /* Consults { @DEV } --> */}
        <ConsultsDiv visible={false} heading="문의" divName="안전관리팀" telNumber="0000" asideLabel="반드시 조회 후 자금신청해주세요." />
        {/* <!-- // Consults { @DEV } --> */}
