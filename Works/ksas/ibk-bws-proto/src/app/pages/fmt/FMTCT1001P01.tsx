/**
 * @description 자금현수송 > 원화현수송 > 자금현수송노선업로드 ~ (LP)자금현수송노선등록
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">자금현수송 노선등록</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">자금현수송 노선등록</span></h4>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)자금현수송노선등록 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
