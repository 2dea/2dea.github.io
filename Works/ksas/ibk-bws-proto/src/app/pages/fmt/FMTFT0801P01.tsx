/**
 * @description 자금현수송 > 외화현수송 > 외국통화견양집 ~ (LP)외화통화등록/수정
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">외화통화등록/수정</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">통화정보</span></h4>
                </div>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`화폐 이미지`} require={true} />
                          </th>
                          <td colSpan={3}>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`주의사항`} require={false} />
                          </th>
                          <td colSpan={3}>
                            <div className="o-field">
                              <div className="fields">
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)외화통화등록/수정 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
