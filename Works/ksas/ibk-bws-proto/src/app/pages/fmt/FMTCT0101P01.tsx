/**
 * @description 자금현수송 > 원화현수송 > 원화현수송신청 ~ (LP)손상권내역조회
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">손상권조회</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-board type-c style-fit">
                <div className="o-notice">
                  ...
                  <div className="main">
                    권종별 손상권 등록내역(전영업일기준)을 통합단말에서 확인해주세요.
                    <span className="inline-binds"><a href="javascript:" className="o-link texted-button _primary">통합단말 바로가기<Icon icon="link" /></a></span>
                  </div>
                </div>
              </div>
              ...
              <form className="m-filter-form">
                <div className="fieldset">
                  ...
                  <div className="o-field">
                    <Label label={`최근등록일자`} require={false} />
                    <div className="fields">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">손상권내역</span></h4>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">권종명</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">전액</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">반액</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">보철권</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">소계</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">불입금액(신청중)</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">금일불입금액</span></div></th>
                          </tr>
                        </thead>
                          ...
                          {[...Array(24)].map((e, idx) => (
                            <>
                              <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>
                                ...
                                <td>{idx + 1}</td>
                                <td className="g-start">5만원권[ 50,000 ]</td>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)손상권내역조회 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
