/**
 * @description 자금현수송 > 외화현수송 > 외화현수송신청관리(업무센터) ~ (LP)업무센터결정
 */
                          ...
                          {[...Array(24)].map((e, idx) => (
                            <>
                              ...
                              <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>
                                ...
                                <td>{idx === 3 - 1 ? <Icon icon="grid-added" /> : idx + 1}</td>{/* 추가된 행 .o-icon._grid-added 순번 대체 { @DEV } */}
