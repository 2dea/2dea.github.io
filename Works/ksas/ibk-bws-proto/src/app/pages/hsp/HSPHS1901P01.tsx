/**
 * @description 중요용지·용도품(본부) > 본부재고관리 > 일람부관리 ~ (LP)일람부등록
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">일람부등록</span></h3>}
      >
