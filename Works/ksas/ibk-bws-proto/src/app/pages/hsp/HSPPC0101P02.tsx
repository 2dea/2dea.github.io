/**
 * @description 중요용지·용도품(본부) > 대금정산 > 업체직배송품목정산 ~ (LP)업체직접배송정산자료생성
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">업체직접배송정산자료생성</span></h3>}
      >
