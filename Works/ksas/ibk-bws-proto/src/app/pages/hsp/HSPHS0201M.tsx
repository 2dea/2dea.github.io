...
function HSPHS0201M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '중요용지·용도품(본부)' }, { label: '본부재고관리' }, { label: '중요용지조달신청' }];
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">신청직원</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">구매유형</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">구매요청명</span></div></th>
                          </tr>
                        </thead>
