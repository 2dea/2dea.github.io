/**
 * @description 중요용지·용도품(영업점) > 조회 > 일련번호원장수정
 */
...
function BSPFD0901M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(영업점)' }, { label: '조회' }, { label: '일련번호원장수정' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">일련번호원장수정</span>
              ...
              <div className="o-section">
                <div className="m-header">
                  ...
                  <div className="o-helper style-strong">
                    <em className="label">서무계 원장만 수정 가능하며, 매수와 일치된 일련번호 등록 시만 거래 가능합니다.</em>
                  </div>
