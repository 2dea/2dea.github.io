/**
 * @description 중요용지·용도품(본부) > 본부재고관리 > 중요용지본부입고
 */
...
function HSPHS0501M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(본부)' }, { label: '본부재고관리' }, { label: '중요용지본부입고' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">중요용지본부입고</span>
              ...
              <div className="o-section">
                <div className="m-header">
                  ...
                  <div className="m-binds">
                    <div className="group">
                      <CommonButton label="검수내역조회" className="_normal" />
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">검수지원<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">신약식</span></div></th>
                        ...
                        <tbody className="p-datatable-tbody">
                          <tr className="p-datatable-emptymessage">
                            <td colSpan={26}>등록된 데이터가 없습니다.</td>
                          </tr>
                        </tbody>
