/**
 * @description 중요용지·용도품(본부) > 영업점배송관리 > 용도품신청분인도
 */
...
function HSPBT1101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(본부)' }, { label: '영업점배송관리' }, { label: '용도품신청분인도' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">용도품신청분인도</span>
                              ...
                              <table className="p-datatable-table p-datatable-scrollable-table">
                                ...
                                <thead className="p-datatable-thead">
                                  <tr>
                                    ...
                                    <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">본부재고</span></div></th>
