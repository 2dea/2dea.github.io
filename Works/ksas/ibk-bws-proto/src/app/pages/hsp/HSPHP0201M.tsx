/**
 * @description 중요용지·용도품(본부) > 본부조달관리(총무부외) > (총무부외)중요용지조달신청접수
 */
...
function HSPHP0201M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(본부)' }, { label: '본부조달관리(총무부외)' }, { label: '(총무부외)중요용지조달신청접수' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">(총무부외)중요용지조달신청접수</span>
            ...
            <SplitterPanel minSize={17.5} className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">조달신청내역</span></h2>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">조달신청명</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">진행상태</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">접수결재상태</span></div></th>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">확정량</span></div></th>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`요청사유`} require={false} />
                          </th>
                          <td colSpan={3}>
