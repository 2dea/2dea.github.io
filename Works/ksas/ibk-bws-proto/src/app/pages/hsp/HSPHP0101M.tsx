/**
 * @description 중요용지·용도품(본부) > 본부조달관리(총무부외) > (총무부외)중요용지조달신청
 */
...
function HSPHP0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(본부)' }, { label: '본부조달관리(총무부외)' }, { label: '(총무부외)중요용지조달신청' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">(총무부외)중요용지조달신청</span>
