/**
 * @description 중요용지·용도품(본부) > 본부재고관리 > 중요용지검수승인등록 ~ (LP)물품검수조서
 */
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">물품 검수 품의서</span></h4>
                </div>
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th colSpan={1}>
                            <Label label={`검수일자`} require={false} />
                          </th>
                          <td colSpan={1}>
                            <span className="o-digit type-date">2025-12-25</span>
                          </td>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">계약량</span></div></th>
