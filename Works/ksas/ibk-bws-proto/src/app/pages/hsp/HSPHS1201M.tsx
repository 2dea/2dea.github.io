/**
 * @description 중요용지·용도품(본부) > 본부재고관리 > 용도품발주명세표
 */
...
function HSPHS1201M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(본부)' }, { label: '본부재고관리' }, { label: '용도품발주명세표' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">용도품발주명세표</span>
