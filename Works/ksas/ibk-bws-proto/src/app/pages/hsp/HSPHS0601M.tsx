/**
 * @description 중요용지·용도품(본부) > 본부재고관리 > 중요용지본부재고조회
 */
...
function HSPHS0601M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(본부)' }, { label: '본부재고관리' }, { label: '중요용지본부재고조회' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">중요용지본부재고조회</span>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        {[...Array(24)].map((e, idx) => (
                          <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>{/* 그리드 최초 진입시 첫번째 행 tr.p-highlight <$tr.trigger('click')> { @DEV } */}
                            ...
                            <td className="g-end">0</td>
                            <td className="g-end">1,222,000</td>
                            <td className="g-end">1,222,000</td>
                            <td className="g-end">300</td>
                            <td className="g-end">1,222,000</td>
                            <td className="g-end">1,222,000</td>
                            <td>가바</td>
                            <td className="g-end">3344785</td>
                            <td>~</td>
