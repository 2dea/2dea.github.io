/**
 * @description 중요용지·용도품(영업점) > 인수도 > 중요용지인수 > (LP)대량폐기결정
 */
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`일련번호(수정 전)`} require={false} />
                          </th>
                          <td colSpan={3}>
                            [0092] 프로세스혁신
                          </td>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`일련번호(수정 후)`} require={true} />
                          </th>
                          <td colSpan={3}>
