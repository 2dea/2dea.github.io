/**
 * @description 중요용지·용도품(본부) > 폐기 > 본부용도품일괄폐기
 */
...
function HSPDU0901M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(본부)' }, { label: '폐기' }, { label: '본부용도품일괄폐기' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">본부용도품일괄폐기</span>
                              ...
                              <table className="p-datatable-table p-datatable-scrollable-table">
                                ...
                                <thead className="p-datatable-thead">
                                  <tr>
                                    ...
                                    <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">폐기취소사유</span></div></th>
                                  </tr>
                                  <tr>
