  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">주소검색</span></h3>}
      >
            ...
            <div className="column">
                  ...
                  <div className="o-field">
                    ...
                    <div className="fields">
                      <div className="o-form _input mode-required">
                        <InputText placeholder="읍면동, 도로명, 건물번호 검색해주세요" value={value} className="bind" onChange={(e) => setValue(e.target.value)} />
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">주소목록</span></h4>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)주소검색 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
