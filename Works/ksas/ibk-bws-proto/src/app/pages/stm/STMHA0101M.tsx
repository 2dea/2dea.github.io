/**
 * @description 재난·안전관리 > 자율보안체계 > 위기상황시대응조편성
 */
...
function STMHA0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '재난·안전관리' }, { label: '자율보안체계' }, { label: '위기상황시대응조편성' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">위기상황시대응조편성</span>
        ...
        <div className="div-contents">
          <Splitter gutterSize={0} className="o-grid">
            <SplitterPanel minSize={17.5} className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">위기상황 시 대응조 편성내역</span></h2>
            ...
            <SplitterPanel minSize={17.5} size={100 * 5 / 12} className="column _views">
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`범인대응조`} require={true} />
                          </th>
                          <td colSpan={1}>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`현장보존조`} require={true} />
                          </th>
                          <td colSpan={1}>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level4"><span className="label">임무정보</span></h4>
                </div>
                      ...
                      <table className="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td colSpan={1} className="g-start">
                              범인 인상착의, 말투, 복장, 차량버호, 범인간 대화내용, 도주방향 등 관찰
                            </td>
                          </tr>
                          <tr>
                            <th colSpan={1}>
