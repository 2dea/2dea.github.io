/**
* @description 재난·안전관리 > 열쇠관리 > 예비열쇠관리 ~ (LP)위탁확인증
 */
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">위탁확인증요청내역</span></h4>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th colSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">위탁보관부점(상대부점)</span></div></th>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)위탁확인증 [wdth-50p(w960)]</span>
            </h1>
          </div>
        </div>
