                                    ...
                                    <div className="fields">
                                      <div className="term">
                                        <div className="question">
                                          <span className="order"><span className="count"></span></span>
                                          <span className="label">정기안전보건교육은 이루어지고 있습니까?</span>
                                        </div>
                                  ...
                                  <fieldset className="o-survey" disabled>
                                    <div className="fields">
                                      <div className="term">
                                        <div className="question">
                                          <span className="order"><span className="count"></span></span>
                                          <span className="label">물질안전보건자료의 교육은 실시되고 있습니까?</span>
                                        </div>
                                  ...
                                  <fieldset className="o-survey" disabled>
                                    <div className="fields">
                                      <div className="term">
                                        <div className="question">
                                          <span className="order"><span className="count"></span></span>
                                          <span className="label">유해화학물질용기(소분용기 포함)에는 내용물에 대한 경고표지를 부착하였습니까?</span>
                                        </div>
                                  ...
                                  <fieldset className="o-survey" disabled>
                                    <div className="fields">
                                      <div className="term">
                                        <div className="question">
                                          <span className="order"><span className="count"></span></span>
                                          <span className="label">보호구를 지급하고 보호구 지급대장을 작성하고 있습니까?</span>
                                        </div>
