/**
 * @description 재난·안전관리 > 가스분사기관리대장(관리자) > 가스분사기관리대장(관리자) ~ (LP)인도등록
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">인도등록</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">인도정보</span></h4>
                </div>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`인도대상부점`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-form _input mode-required wdth-50p">
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)인도등록 [wdth-50p(w960)]</span>
            </h1>
          </div>
        </div>
