/**
* @description 재난·안전관리 > 열쇠관리 > 예비열쇠관리 ~ (LP)위탁열쇠반납요청
 */
  ...
  return (
    <>
      <Dialog
        ...
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">위탁열쇠반납요청</span></h3>}
      >
        <div className="div-container">
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">열쇠반납요청</span></h4>
                </div>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`반납요청사유`} require={true} />
                          </th>
                          <td colSpan={3}>
          ...
          <div className="o-grid">
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">우리부점 &rarr; 다른부점 위탁보관내역</span></h5>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th colSpan={5} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">위탁보관부점(상대부점)</span></div></th>
                          ...
                          <tr>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">위탁승인일자</span></div></th>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)위탁열쇠반납요청 [wdth-50p(w960)]</span>
            </h1>
          </div>
        </div>
