/**
 * @description 재난·안전관리 > 배차관리 > 배차신청 ~ (LP)배차신청결재상태
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={false}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">배차신청결재상태</span></h3>}
      >
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)배차신청결재상태 [wdth-25p]</span>
            </h1>
          </div>
        </div>
