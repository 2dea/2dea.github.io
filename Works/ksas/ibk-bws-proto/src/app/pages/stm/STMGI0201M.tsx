                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`가스분사기번호`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
                          ...
                          <th colSpan={1}>
                            <Label label={`가스분사기형식`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`소지허가증`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
                          ...
                          <th colSpan={1}>
                            <Label label={`약체교체일자`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
