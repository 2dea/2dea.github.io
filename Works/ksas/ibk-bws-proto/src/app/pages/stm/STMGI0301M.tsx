/**
* @description 재난·안전관리 > 가스분사기대장관리 > 가스분사기이력조회
 */
...
function STMGI0301M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '재난·안전관리' }, { label: '가스분사기대장관리' }, { label: '가스분사기이력조회' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">가스분사기이력조회</span>
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">가스분사기관리이력</span></h2>
