/**
 * @description 재난·안전관리 > 버스배차신청 > 배차집계
 */
...
function STMBR0301M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '재난·안전관리' }, { label: '버스배차신청' }, { label: '배차집계' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">배차집계</span>
          ...
          <div className="binds">
            ...
            <div className="m-binds type-end">
              ...
              <div className="group _primary">
                <CommonButton label="단가표" className="_solid-primary" />
              </div>
            </div>
          </div>
        </div>
