/**
 * @description 재난·안전관리 > 기계경비당직관리 > 당직신청관리 ~ (LP)당직신청
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">당직신청</span></h3>}
      >
            ...
            <div className="column">
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">당직명령(신청서)</span></h4>
                </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)당직신청 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
