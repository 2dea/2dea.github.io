/**
 * @description 재난·안전관리 > 자율보안체계 > 분임보안담당관인수인계서현황
 */
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">분임보안담당관인수인계서현황</span>
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <th colSpan={1}>
                            <Label label={<>인수자 <br />(후임 분임​보안담당자)</>} require={false} />
                          </th>
                          <td colSpan={1}>
                            [0034] 을지로
                          </td>
