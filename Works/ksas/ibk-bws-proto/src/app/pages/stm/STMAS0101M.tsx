/**
 * @description 재난·안전관리 > 자율보안체계 > 보안업무세부추진계획
 */
...
function STMAS0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '재난·안전관리' }, { label: '자율보안체계' }, { label: '보안업무세부추진계획' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">보안업무세부추진계획</span>
