...
function STMFL0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '재난·안전관리' }, { label: '소방안전관리' }, { label: '소화기신청' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">소화기신청</span>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`신정부점`} require={false} />
                          </th>
                          <td colSpan={1}>
                            [0034] 을지로
                          </td>
                        ...
                        <tr>
                          ...
                          <th colSpan={1}>
                            <Label label={`결재일자`} require={false} />
                          </th>
                          <td colSpan={1}>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`견적서첨부`} require={true} />
                          </th>
                          <td colSpan={3}>
                            <div className="o-field">
                              <div className="fields">
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">소화기종류<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">구매일자<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">신청사유<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
              ...
              <div className="o-section">
                <div className="o-board type-a">
                  <div className="board-container">
                    ...
                    <ul className="m-bullets type-disc">
                      <li>(견적) 인터넷 &lt;분말소화기&gt; 검색하여 단가 17,000원 이하 제품(수입품)으로 견적서 받아주세요.</li>
                      <li>(절차) 소화기신청 &gt; 안전관리팀 예산 재배정 &gt; 부점에서 소화기를 구입하여 배치합니다.</li>
                      <li>(대장정리) 소화기 신청 결재승인 시 소화기관리대장에 소화기 정보가 자동으로 생성됩니다.</li>
                      <li>(폐기) 노후소화기는 자체 폐기하거나, 시군구청 홈페이지에서 대형폐기물 배출신청 또는 대형폐기물 스티커(개당 3,000원 내외)를 구입하여 배출하시면 됩니다.</li>
                    </ul>
                  </div>
                </div>
              </div>
