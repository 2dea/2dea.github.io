/**
 * @description 재난·안전관리 > 자율보안체계 > 위기상황시대응조편성현황
 */
...
function STMHA0201M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '재난·안전관리' }, { label: '자율보안체계' }, { label: '위기상황시대응조편성현황' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">위기상황시대응조편성현황</span>
