            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">차량번호별 관리자 지정</span></h4>
                </div>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">관리자</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">직급</span></div></th>
                          </tr>
                        </thead>
                ...
                <div className="m-footer">
                  <ul className="m-bullets type-disc">
                    <li>업무용 차량 공지사항, 운행일지 알림 등 안내를 목적으로 하고 있습니다.</li>
                  </ul>
                </div>
