/**
 * @description 재난·안전관리 > 열쇠관리 > 열쇠등록관리 ~ (LP)열쇠이미지확대
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">열쇠이미지확대</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">열쇠이미지확대</span></h4>
                </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)열쇠이미지확대 [wdth-50p(w960)]</span>
            </h1>
          </div>
        </div>
