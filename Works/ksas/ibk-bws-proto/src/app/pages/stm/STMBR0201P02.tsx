/**
 * @description 재난·안전관리 > 버스배차신청 > 버스배차일정표 ~ (LP)일정상세보기
 */
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th colSpan={1}>
                            <Label label={`휴대폰번호`} require={false} />
                          </th>
                          <td colSpan={1}>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`이용목적`} require={false} />
                          </th>
                          <td colSpan={1}>대면상품집합교육</td>

                          <th colSpan={1}>
                            <Label label={`운행구분`} require={false} />
                          </th>
                          <td colSpan={1}>왕복</td>
                        </tr>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`탑승인원`} require={false} />
                          </th>
                          <td colSpan={1}>70명</td>

                          <th colSpan={1}>
                            <Label label={`차량대수`} require={false} />
                          </th>
                          <td colSpan={1}>2대</td>
                        </tr>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`이용시작일자`} require={false} />
                          </th>
                          <td colSpan={1}>
                            <span className="o-digit type-date">2025-12-25</span>
                          </td>
                          ...
                          <th colSpan={1}>
                            <Label label={`이용종료일자`} require={false} />
                          </th>
                          <td colSpan={1}>
                            <span className="o-digit type-date">2025-12-25</span>
                          </td>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`출발장소`} require={false} />
                          </th>
                          <td colSpan={1}>본점</td>

                          <th colSpan={1}>
                            <Label label={`도착장소`} require={false} />
                          </th>
                          <td colSpan={1}>충주연수원</td>
                        </tr>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`도착지출발시각`} require={false} />
                          </th>
                          <td colSpan={3}></td>
                        </tr>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)일정상세보기 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
