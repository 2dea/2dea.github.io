/**
 * @description 재난·안전관리 > 기계경비당직관리 > 기계경비보안관리(관리자)
 */
...
function STMGD0501M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '재난·안전관리' }, { label: '기계경비당직관리' }, { label: '기계경비보안관리(관리자)' }];
        ...
        <div className="div-header">
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">기계경비보안관리(관리자)</span>
          ...
          <div className="binds">
            <div className="m-binds type-start">
              <div className="group">
                <CommonButton label="명령부 복수부점 관리" className="_lined-secondary" />
              </div>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">요일</span></div></th>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">대직자</span></div></th>
                            <th colSpan={4} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">대직자 결재</span></div></th>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">지점세트시각</span></div></th>
                            <th colSpan={4} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">점검표 결재</span></div></th>
                            <th colSpan={4} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">명령부 결재</span></div></th>
                          </tr>
                            ...
                            <>
                              {
                                ...
                                <tr className="p-rowgroup-header">
                                  <td colSpan={20} className="p-x-cell-blank"></td>{/* rowGroupHeaderTemplate={blankCellHeaderTemplate} :: 그리드 로우그룹/rowspan 커스텀 템플릿 추가 필요 { @DEV } */}
                                </tr>
                              }
                              ...
                              </tr>
                              {
                                ...
                                <tr className="p-rowgroup-footer">
                                  <td colSpan={20} className="p-x-cell-blank"></td>{/* rowGroupFooterTemplate={blankCellFooterTemplate} :: 그리드 로우그룹/rowspan 커스텀 템플릿 추가 필요 { @DEV } */}
                                </tr>
                              }
                            </>
                          ))}
