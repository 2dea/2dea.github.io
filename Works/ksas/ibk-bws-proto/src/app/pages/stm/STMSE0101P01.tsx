                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">최종수정자</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">최종수정일자</span></div></th>
                          </tr>
                        </thead>
                            ...
                            <div className="o-field">
                              <div className="fields">
                                <div className="m-checks">
                                  <InputCheck label="영업점" defaultChecked />
                                  <InputCheck label="지역본부" defaultChecked />
                                  <InputCheck label="본부" defaultChecked />
                                </div>
                              </div>
                            </div>
                          </td>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)점검표등록 [wdth-50p(w960)]</span>
            </h1>
          </div>
        </div>
