/**
 * @description 재난·안전관리 > 열쇠관리 > 열쇠인수도관리 ~ (LP)과거내역조회
 */
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">금고열쇠인수도부관리</span></h4>
                </div>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th colSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">인계자</span></div></th>
                ...
                <div className="m-footer">
                  <ul className="m-bullets type-disc">
                    <li className="c-color-strong"><em>금고열쇠인수도부는 [열쇠관리 &gt; 열쇠등록관리] 메뉴에서 등록해 주세요.</em></li>
                  </ul>
                </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)과거내역조회 [wdth-50p(w960)]</span>
            </h1>
          </div>
        </div>
