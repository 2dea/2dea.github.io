/**
 * @description 재난·안전관리 > 열쇠관리 > 예비열쇠관리 ~ (LP)열쇠이미지보기
 */
  ...
  return (
    <>
      <Dialog
        ...
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">열쇠이미지보기</span></h3>}
      >
            ...
            <div className="column">
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">자동 열쇠이미지보기</span></h4>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)열쇠이미지보기 [wdth-50p(w960)]</span>
            </h1>
          </div>
        </div>
