/**
 * @description 재난·안전관리 > 도급사업관리 > 순회점검표 등록
 */
...
function STMSC0401M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '재난·안전관리' }, { label: '도급사업관리' }, { label: '순회점검표 등록' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">순회점검표 등록</span>
