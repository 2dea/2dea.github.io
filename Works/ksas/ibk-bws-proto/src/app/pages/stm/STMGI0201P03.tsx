                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`접수부점`} require={false} />
                          </th>
                          <td colSpan={1}>
                            [0810] 프로세스혁신
                          </td>
                          ...
                          <th colSpan={1}>
                            <Label label={`접수 담당자`} require={false} />
                          </th>
                          <td colSpan={1}>
                            [0810] 홍길동
                          </td>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`신고일자`} require={false} />
                          </th>
                          <td colSpan={1}>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`신고(대상)부점`} require={false} />
                          </th>
                          <td colSpan={1}>[0810] 프로세스혁신</td>

                          <th colSpan={1}>
                            <Label label={`신고부점 담당자`} require={false} />
                          </th>
