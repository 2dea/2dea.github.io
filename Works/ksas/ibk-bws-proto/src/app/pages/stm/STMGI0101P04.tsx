                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`신고부점`} require={false} />
                          </th>
                          <td colSpan={1}>
                            [0810] 프로세스혁신
                          </td>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`신고(상대)부점`} require={true} />
                          </th>
                          <td colSpan={1}>
                            [0810] 안전관리팀
                          </td>
                          ...
                          <th colSpan={1}>
                            <Label label={`신고부점 담당자`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
                        ...
                        <tr>
                          ...
                          <td colSpan={3}>
                            <div className="o-field">
                              <div className="fields">
                                <div className="o-form _select wdth-60 mode-required">
                                  <XDropdown appendTo={'self'} className="bind" />
                                  <i aria-hidden="true"></i>
                                </div>
