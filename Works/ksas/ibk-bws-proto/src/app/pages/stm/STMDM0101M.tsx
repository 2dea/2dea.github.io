...
function STMDM0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '재난·안전관리' }, { label: '배차관리' }, { label: '배차신청' }];
        ...
        <div className="div-contents">
          <Splitter gutterSize={0} className="o-grid">
            <SplitterPanel minSize={17.5} className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">배차신청내역</span></h2>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">용무</span></div></th>
                          </tr>
                          <tr>
            ...
            <SplitterPanel minSize={17.5} size={100 * 5 / 12} className="column _views">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">배차가능차량</span></h2>
                  ...
                  <div className="o-field">
                    <div className="fields">
                      <div className="o-form _select wdth-40">
                        <XDropdown placeholder="위치 선택" appendTo={document.body} className="bind" />
                        <i aria-hidden="true"></i>
                      </div>
                    </div>
                  </div>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h3 className="o-heading level3"><span className="label">배차신청</span></h3>
                </div>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`신청차량`} require={true} />
                          </th>
                          <td colSpan={3}>
                            26호 3486 / YF소나타 / IT 센터
                          </td>
                        </tr>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`도착예정일자`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
                          ...
                          <th colSpan={1}>
                            <Label label={`도착예정시각`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`요청사유(구체적으로)`} require={true} />
                          </th>
                          <td colSpan={3}>
                            <div className="o-field">
                              <div className="fields">
          ...
          <div className="m-footer">
            <ul className="m-bullets type-disc">
              <li className="c-color-strong"><em>배차신청은 반드시 출발 전에 해주시기 바랍니다. 신청 후 1시간 경과 시 배차 자동 취소됨.</em></li>
              <li className="c-color-strong"><em>배차신청은 당일자에 한하며, 당일 출차되지 않을 시 자동 취소되오니 유의하시기 바랍니다.</em></li>
            </ul>
          </div>
        </div>
        {/* <!-- // Contents { @DEV } --> */}
