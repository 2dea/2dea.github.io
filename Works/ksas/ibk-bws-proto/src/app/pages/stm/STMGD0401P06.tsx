/**
 * @description 행내등기·우편물 > 행내등기 > 행내등기신청 ~ (LP)명령부등록
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">명령부등록</span></h3>}
      >
        <div className="div-container">
          <div className="o-grid">
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">점검자 선택</span></h4>

                  <div className="o-helper">
                    <em className="label c-color-strong">점검자1에</em> 순서대로 지정됩니다.
                  </div>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">직책구분</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">직책</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">이동</span></div></th>
                          </tr>
                        </thead>
                            ...
                            <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>{/* 그리드 최초 진입시 첫번째 행 tr.p-highlight <$tr.trigger('click')> { @DEV } */}
                              ...
                              <td>
                                <div className="m-inline-binds">
                                  <ImageButton label="위로" icon="page-up" iconWidth={50} />
                                  <ImageButton label="아래로" icon="page-down" iconWidth={50} />
                                </div>
                              </td>
                            </tr>
                          ))}
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)명령부등록 [wdth-60p(w960)]</span>
            </h1>
          </div>
        </div>
