/**
 * @description 재난·안전관리 > 기계경비당직관리 > 당직비정산 ~ (LP)직원별당직비산정결과
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={false}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">직원별 당직비 산정결과</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">직원별 당직비 산정내역</span></h4>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">당직사유</span></div></th>
                          </tr>
                        </thead>
                        ...
                        <tbody className="p-datatable-tbody">
                          {[...Array(24)].map((e, idx) => (
                            <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>{/* 그리드 최초 진입시 첫번째 행 tr.p-highlight <$tr.trigger('click')> { @DEV } */}
                              ...
                              <td className="g-start">지점 레이아웃 공사</td>
                            </tr>
                          ))}
                        </tbody>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)직원별당직비산정결과 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
