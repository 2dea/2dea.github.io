        ...
        <div className="div-header">
          ...
          <div className="binds">
            <div className="m-binds type-start">
              <div className="group">
                <CommonButton label="대직자등록" className="_lined-secondary" />
                <CommonButton label="당직점검표등록" className="_lined-secondary" />
              </div>
            ...
            <div className="m-binds type-end">
              <div className="group _primary">
                ...
                <CommonButton label="안전관리팀결재요청" className="_solid-primary" />
                <CommonButton label="당직결재요청" className="_solid-primary" />
              </div>
            </div>
          </div>
        </div>
              ...
              <form className="m-filter-form">
                <div className="fieldset">
                  ...
                  <div className="o-field">
                    <Label label={`오서손구분`} require={true} />
                    <div className="fields">
                  ...
                  <div className="o-field">
                    <Label label={`기계경비당직관리장소`} require={false} />
                    <div className="fields">
                      <div className="o-form _select">
                        <XDropdown appendTo={'self'} className="bind" />
                        <i aria-hidden="true"></i>
                  ...
                  <div className="o-field">
                    <Label label={`일괄기계경비당직관리여부`} require={false} />
                    <div className="fields">
                      <div className="o-form _select">
                        <XDropdown appendTo={'self'} className="bind" />
                        <i aria-hidden="true"></i>
                        ...
                        <table className="p-datatable-table p-datatable-scrollable-table">
                          ...
                          <thead className="p-datatable-thead">
                            <tr>
                              ...
                              <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">오손사유</span></div></th>
                              <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">기계경비당직관리장소</span></div></th>
                              ...
                              <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">스캔내역</span></div></th>
                              <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">업무이력조회</span></div></th>
                            </tr>
                            <tr>
                          ...
                          {[...Array(24)].map((e, idx) => (
                            <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>{/* 그리드 최초 진입시 첫번째 행 tr.p-highlight <$tr.trigger('click')> { @DEV } */}
                              ...
                              <td>0009</td>
                              <td>홍길동</td>
                              <td className="g-end">31</td>
                              <td>다가</td>
                              <td>0022</td>
                              <td>~</td>
                              <td>2218686</td>
                              <td className="g-start">일괄기계경비당직관리</td>
                              <td>센터</td>
                              <td>N</td>
                              <td><span className="o-digit type-date">2025-12-25</span></td>
                              <td>0009</td>
