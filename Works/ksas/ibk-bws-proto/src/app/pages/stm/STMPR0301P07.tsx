/**
 * @description 재난·안전관리 > 출입증/방문증 > 출입증현황관리 ~ (LP)반려내역
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">반려내역</span></h3>}
      >
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)반려내역 [wdth-50p(w960)]</span>
            </h1>
          </div>
        </div>
