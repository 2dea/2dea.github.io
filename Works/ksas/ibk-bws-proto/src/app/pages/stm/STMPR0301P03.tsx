/**
 * @description 재난·안전관리 > 출입증/방문증 > 출입증현황관리 ~ (LP)재발급
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">재발급</span></h3>}
      >
              ...
              <div className="o-section">
                <div className="o-board type-a">
                  <div className="board-container">
                    <div className="m-header">
                      <strong className="o-heading"><span className="label">재발급 비용 안내</span></strong>
                    </div>

                    <ul className="m-bullets type-disc">
                      <li>재발급 비용은 사용자 본인이 부담하며, 입금 시 반드시 성명+출입증번호를 표기하시기 바랍니다.</li>
                      <li>재발급 비용(재료 구입단가): 9,200원(카드 4,300원, 목걸이 4,000원, 케이스 900원)</li>
                      <li>입금계좌: 기업은행 001-112938-01-645</li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)재발급 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
