/**
 * @description 재난·안전관리 > 자율보안체계 > 분임보안담당관인수인계서
 */
...
function STMHA0301M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '재난·안전관리' }, { label: '자율보안체계' }, { label: '분임보안담당관인수인계서' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">분임보안담당관인수인계서</span>
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td colSpan={1}>
                            <div className="o-field">
                            <Label label={`후임 분임보안담당관`} require={false} />
                            <div className="fields">
                                <div className="o-form _input wdth-50">
                                  <InputText placeholder="" value={value} className="bind" onChange={(e) => setValue(e.target.value)} />
                                  <i aria-hidden="true"></i>
