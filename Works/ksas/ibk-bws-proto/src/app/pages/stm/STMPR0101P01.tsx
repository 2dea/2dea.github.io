/**
 * @description 재난·안전관리 > 출입증/방문증 > 출입증신청 ~ (LP)반려내역불러오기
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">반려내역불러오기</span></h3>}
      >
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        {[...Array(24)].map((e, idx) => (
                          <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>{/* 그리드 최초 진입시 첫번째 행 tr.p-highlight <$tr.trigger('click')> { @DEV } */}
                            ...
                            <td>000000</td>
                            <td>홍길동</td>
                            <td className="g-start">차세대 시스템 개선</td>
                            <td className="g-start">수지IT센터</td>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)반려내역불러오기 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
