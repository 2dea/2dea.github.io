/**
 * @description 행내등기·우편물 > 우편물 > 우편물신청내역
 */
...
function BEXPM0201M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '행내등기·우편물' }, { label: '우편물' }, { label: '우편물신청내역' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">우편물신청내역</span>
            ...
            <div className="m-binds type-end">
              <div className="group _utility">
                <div className="m-print-binds">
                  <CommonButton label="발송명세서 출력" className="_texted" />
                </div>
              </div>
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">우편물 신청정보</span></h2>
                ...
                <div className="m-footer">
                  <ul className="m-bullets type-disc">
                    <li className="c-color-strong"><em>체크박스는 발송명세서 출력 시만 사용 가능합니다. EMS문의(8-4331)</em></li>
                  </ul>
                </div>
