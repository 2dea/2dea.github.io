/**
 * @description 행내등기·우편물 > 등기우편물 > 등기우편물관리대장 ~ (LP)등기우편물인수
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">등기우편물인수</span></h3>}
      >
        <div className="div-container">
          <div className="o-grid">
            <div className="column">
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th colSpan={1}>
                            <Label label={`전자문서`} require={false} />
                          </th>
                          <td colSpan={1}>
                            <CommonButton label="서명" className="_normal" />
                          </td>
                        </tr>
                      </tbody>
                    </table>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">접수내역</span></h5>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)등기우편물인수 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
