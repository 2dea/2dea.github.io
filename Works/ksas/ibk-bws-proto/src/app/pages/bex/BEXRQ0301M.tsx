/**
 * @description 행내등기·우편물 > 행내등기 > 행내등기검수
 */
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">행내등기검수</span>
          ...
          <div className="binds">
            ...
            <div className="m-binds type-end">
              ...
              <div className="group _primary">
                <CommonButton label="배송취소" className="_lined-primary" />
                <CommonButton label="배송" className="_solid-primary" />
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">행내등기우편 내역</span></h2>
                        ...
                        <table className="p-datatable-table p-datatable-scrollable-table">
                          ...
                          <thead className="p-datatable-thead">
                            <tr>
                              ...
                              <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">배송일자</span></div></th>
                              <th colSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">배송처리자</span></div></th>
                              ...
                              <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">노선지역구분</span></div></th>
                            </tr>
                            <tr>
