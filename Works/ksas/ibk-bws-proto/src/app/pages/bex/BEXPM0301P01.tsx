/**
 * @description 행내등기·우편물 > 우편물 > 우편물검수 ~ (LP)우편물일괄검수등록
 */
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">검수자 정보</span></h4>
                </div>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">우편물 신청내역</span></h4>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h3 className="o-heading level3"><span className="label">신청상세내역</span></h3>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">우편물내용</span></div></th>
                          </tr>
                        </thead>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)우편물일괄검수등록 [wdth-70p(w1340)]</span>
            </h1>
          </div>
        </div>
