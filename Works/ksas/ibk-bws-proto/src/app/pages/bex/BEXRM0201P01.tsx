/**
 * @description 행내등기·우편물 > 등기우편물 > 등기우편물관리대장 ~ (LP)등기우편물접수
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">등기우편물접수</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">접수정보</span></h4>
                </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)등기우편물접수 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
