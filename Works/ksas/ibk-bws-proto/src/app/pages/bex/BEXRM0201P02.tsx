/**
 * @description 행내등기·우편물 > 등기우편물 > 등기우편물관리대장 ~ (LP)등기우편물통보결과
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">등기우편물통보결과</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">로봇배송결과등록</span></h4>
                </div>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">선택정보</span></h5>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)등기우편물통보결과 [wdth-70p(w1340)]</span>
            </h1>
          </div>
        </div>
