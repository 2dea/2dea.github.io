/**
 * @description 행내등기·우편물 > 등기우편물 > 등기우편물관리대장 ~ (LP)로봇배송등록
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">로봇배송등록</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">일괄적용대상</span></h4>
                </div>
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <th colSpan={1}>
                            <Label label={`통보구분`} require={false} />
                          </th>
                          <td colSpan={1}>
                            로봇배송
                          </td>
                        ...
                        <tr>
                          ...
                          <th colSpan={1}>
                            <Label label={`통보방법`} require={false} />
                          </th>
                          <td colSpan={1}>
                            <div className="m-checks">
                              <InputCheck label="IBK톡" />
                              <InputCheck label="카카오톡" />
                            </div>
                          </td>
                        </tr>
                        <tr>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th colSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">수취부점</span></div></th>
                            <th colSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">수취자</span></div></th>
                          </tr>
                          <tr>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)로봇배송등록 [wdth-50p(w960)]</span>
            </h1>
          </div>
        </div>
