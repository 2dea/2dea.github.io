...
function BSPRQ0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '중요용지·용도품(영업점)' }, { label: '신청' }, { label: '중요용지신청' }];
            ...
            <div className="lists">
              ...
              <div className="o-tab type-c">
                <ul className="lists">
                  ...
                  <li><a href="javascript:" className="link"><span className="label">수표어음류</span></a></li>
                  <li><a href="javascript:" className="link"><span className="label">중금채류</span></a></li>
                  <li><a href="javascript:" className="link"><span className="label">통장류</span></a></li>
                  <li><a href="javascript:" className="link"><span className="label">카드류</span></a></li>
                  <li><a href="javascript:" className="link"><span className="label">외화수표류</span></a></li>
                  <li><a href="javascript:" className="link"><span className="label">증서류</span></a></li>
                  <li><a href="javascript:" className="link"><span className="label">상품권류</span></a></li>
                </ul>
              </div>
              ...
              <Tabs className="o-section" defaultIndex={0}>
                <div className="m-header">
                  <div className="m-checks justify-start">
                    <InputCheck moduleId="BSPRQ0101M-tooltip-10" label="재고부족 품목" />
                    <Tooltip className="o-tooltip" target="#BSPRQ0101M-tooltip-10" position="top">
                      자동배송설정 상태가 "등록"인 품목이 노출됩니다.
                    </Tooltip>
                  </div>
                ...
                <div className="m-shop-ranking">
                  <div className="header">
                    <div className="heading">
                      <strong className="label">우리부점 재고부족 품목</strong>
                    </div>
                  </div>
