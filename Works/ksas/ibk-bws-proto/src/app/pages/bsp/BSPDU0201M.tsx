/**
 * @description 중요용지·용도품(영업점) > 폐기 > 오손처리진행상태조회
 */
...
function BSPDU0201M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(영업점)' }, { label: '폐기' }, { label: '오손처리진행상태조회' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">오손처리진행상태조회</span>
            ...
            <div className="m-binds type-end">
              <div className="group _utility">
                <div className="m-print-binds">
                  <CommonButton label="오손등록명세서 출력" className="_texted" />
            ...
            <div className="column">
              ...
              <form className="m-filter-form">
                <div className="fieldset">
                  ...
                  <div className="o-field">
                    <Label label={`일괄폐기여부`} require={false} />
                    <div className="fields">
                      <div className="o-form _select">
                        <XDropdown appendTo={'self'} className="bind" />
                        <i aria-hidden="true"></i>
