/**
 * @description 중요용지·용도품(영업점) > 인수도 > 중요용지창구 → 서무계
 */
...
function BSPAQ0401M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(영업점)' }, { label: '인수도' }, { label: '중요용지창구 → 서무계' }];
            ...
            <div className="main">
              ...
              <div className="m-title">
                <h1 className="o-heading level1">
                  <span className="label">중요용지창구 &rarr; 서무계</span>
                      ...
                      <div className="column">
                        <div className="o-section">
                          <div className="m-header">
                            <h2 className="o-heading level2"><span className="label">창구재고내역</span></h2>
                        ...
                        <div className="o-section">
                          <div className="m-header">
                            <h2 className="o-heading level2"><span className="label">창구 &rarr; 서무계</span></h2>
                          </div>
                          ...
                          <div className="o-board type-a">
                            <div className="board-container">
                              ...
                              <ul className="m-bullets type-disc">
                                <li className="c-color-strong"><em>OTP발생기(OT003) 중 일련번호 자리수가 10자리인 경우 앞에서부터 9자리를 입력하시기 바랍니다.</em></li>
                                <li className="c-color-strong"><em>기호 입력 예시: 가나(실물의 일련번호 앞뒤 한글을 한번에 모아서 입력)</em></li>
                                <li className="c-color-strong"><em>일련번호가 없는 중요용지의 경우 수량에 맞게 일련번호를 임의로 입력하시기 바랍니다. 예시) 1~100</em></li>
                  ...
                  <TabPanel className="m-tabs-panel react-tabs__tab-panel">
                    <div className="o-grid">
                      <div className="column">
                        ...
                        <div className="o-section">
                          <div className="m-header">
                            <h2 className="o-heading level2"><span className="label">서무계인도내역</span></h2>
                            <div className="o-length">
                              <span className="head">전체</span>
                              <em className="data">
                                <span className="value">8</span>
