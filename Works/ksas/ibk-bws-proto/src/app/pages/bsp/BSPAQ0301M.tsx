...
function BSPAQ0301M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '중요용지·용도품(영업점)' }, { label: '인수도' }, { label: '중요용지서무계 → 창구' }];
                    ...
                    <div className="o-board type-a">
                      <div className="board-container">
                        ...
                        <ul className="m-bullets type-disc">
                          <li className="c-color-strong"><em>OTP발생기(OT003) 중 일련번호가 '0'으로 시작하는 경우 9자리를 입력하시기 바랍니다.</em></li>
                          ...
                          <li className="c-color-strong"><em>인수결재가 완료되어야 서무계 재고가 반영되오니 결재를 확인하시기 바랍니다.</em></li>
