/**
 * @description 중요용지·용도품(영업점) > 폐기 > 중요용지사고보고(본부)
 */
...
function BSPDU0402M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '중요용지·용도품(영업점)' }, { label: '폐기' }, { label: '중요용지사고보고(본부)' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">중요용지사고보고(본부)</span>
              ...
              <form className="m-filter-form">
                <div className="fieldset">
                  ...
                  <div className="o-field">
                    <Label label={`결재대상`} require={false} />
                    <div className="fields">
                  ...
                  <div className="o-section">
                    ...
                    <div className="m-footer">
                      <ul className="m-bullets type-disc">
                        <li className="c-color-strong"><em>오손등록 후 결재완료된 경우 대상내역 조회가 가능합니다.</em></li>
                      </ul>
                    </div>
