/**
 * @description 수수료관리 > 자금현수송수수료 > 월별금액검증 ~ (LP)세금계산서보기
 */
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">세금계산서 보기</span></h4>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)세금계산서보기 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
