/**
 * @description 수수료관리 > 자금현수송수수료 > 계약서관리 ~ (LP)부점별 수수료율
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">부점별 수수료율</span></h3>}
      >
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)부점별 수수료율 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
