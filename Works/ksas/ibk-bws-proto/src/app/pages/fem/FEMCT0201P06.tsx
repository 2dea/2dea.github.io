/**
 * @description 수수료관리 > 자금현수송수수료 > 월별금액검증 ~ (LP)계약정보불러오기
 */
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">전담 총 계약금액</span></div></th>
