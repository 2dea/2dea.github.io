/**
 * @description 수수료관리 > 원화정사수수료 > 지급결의 ~ (LP)지급수수료상세등록
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">지급수수료상세등록</span></h3>}
      >
