/**
 * @description 수수료관리 > 원화정사수수료 > 계약서관리 ~ (LP)중도해지
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">중도해지</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">계약정보</span></h4>
                </div>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">해지정보</span></h5>
                </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)중도해지 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
