/**
 * @description 영업지원 > 서식장부관리 > 출급번호관리
 */
...
function BSSFM0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '영업지원' }, { label: '서식장부관리' }, { label: '출급번호관리' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">출급번호관리</span>
          ...
          <div className="binds">
            <div className="m-binds type-start">
              <div className="group">
                ...
                <CommonButton label="분류관리" className="_lined-secondary" />
              </div>
            ...
            <div className="column">
              ...
              <form className="m-filter-form">
                <div className="fieldset">
                  ...
                  <div className="o-field colspan-2">
                    <Label label={`요청기간`} require={false} />
                    <div className="fields">
                      <div className="o-form _input type-date wdth-50">
                        <Calendar placeholder="" value={Date} locale="ko" dateFormat="yy-mm-dd" mask="9999-99-99" appendTo={document.body} className="bind" onChange={(e) => setDate(e.value)} showIcon icon={<Icon icon="calendar" />} />
                        <i aria-hidden="true"></i>
                  ...
                  <div className="o-field">
                    <Label label={`중요용지`} require={false} />
                    <div className="fields">
                      <div className="o-form _select">
                        <XDropdown appendTo={'self'} className="bind" />
                        <i aria-hidden="true"></i>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">분류</span></div></th>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">용도품</span></div></th>
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">중요용지</span></div></th>
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">BPR</span></div></th>
                            ...
                            <th colSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">담당부서</span></div></th>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">첨부</span></div></th>
