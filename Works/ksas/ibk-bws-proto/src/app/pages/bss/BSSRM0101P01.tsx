/**
 * @description 영업지원 > 토지보상우편물  > 토지보상우편물 ~ (LP)공지(메모/알림)관리
 */
        ...
        <div className="div-container">
          <div className="o-grid">
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h6 className="o-heading level4"><span className="label">메모내용</span></h6>
                        ...
                        <div className="o-form _input">
                          ...
                          <div className="o-limit type-length">
                            ...
                            <span className="data">
                              ...
                              <span className="limits" aria-label="입력가능 글자수">2000</span>
                            </span>
                          </div>
                        </div>
                      </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)공지(메모/알림)관리 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
