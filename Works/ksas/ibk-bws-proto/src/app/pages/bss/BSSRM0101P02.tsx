/**
 * @description 영업지원 > 토지보상우편물  > 토지보상우편물 ~ (LP)이관등록
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">이관등록</span></h3>}
      >
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`이관대상부점`} require={true} />
                          </th>
                          <td colSpan={1}>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)이관등록 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
