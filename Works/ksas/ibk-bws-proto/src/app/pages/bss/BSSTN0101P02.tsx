/**
 * @description 영업지원 > 채권양도통지(B2B팩토링) > 채권양도통지(B2B팩토링) ~ (LP)채권양도일괄검수등록
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">채권양도 일괄검수 등록</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">검수정보</span></h4>
                </div>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`검수부점`} require={true} />
                          </th>
                          <td colSpan={1}>
                            [0810] 프로세스혁신
                          </td>
                          <th colSpan={1}>
                            <Label label={`검수직원`} require={true} />
                          </th>
                          <td colSpan={1}>
                            [0810] 홍길동
                          </td>
                          ...
                          <th colSpan={1}>
                            <Label label={`총 통신비`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">채권양도통지 내역</span></h5>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">총발송건수</span></div></th>
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">총통신비</span></div></th>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)채권양도일괄검수등록 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
