/**
 * @description 영업지원 > 토지보상우편물 > 토지보상우편물
 */
...
function BSSRM0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '영업지원' }, { label: '토지보상우편물' }, { label: '토지보상우편물' }];
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td colSpan={3} className="g-valign-top">
                          ...
                          <th colSpan={1}>
                            <Label label={`등기본등본 & 관리서류`} require={false} />
                          </th>
                          <td colSpan={3}>
