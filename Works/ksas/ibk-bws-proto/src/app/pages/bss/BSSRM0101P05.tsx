/**
 * @description 영업지원 > 토지보상우편물  > 토지보상우편물 ~ (LP)인수취소
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">인수취소</span></h3>}
      >
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)인수취소 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
