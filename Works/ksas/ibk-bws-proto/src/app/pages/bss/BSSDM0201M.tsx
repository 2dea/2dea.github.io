...
function BSSDM0201M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '영업지원' }, { label: '문서관리' }, { label: '문서대량폐기' }];
        ...
        <div className="div-header">
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">문서대량폐기</span>
          ...
          <div className="binds">
            ...
            <div className="m-binds type-end">
              ...
              <div className="group _primary">
                <CommonButton label="폐기정산" className="_solid-primary" />
                <CommonButton label="폐기정보입력" className="_solid-primary" />
                <CommonButton label="본부반려" className="_lined-primary" />
                <CommonButton label="수거예정일입력" className="_solid-primary" />
        ...
        <div className="div-contents">
          ...
          <Splitter gutterSize={0} className="o-grid">
            <SplitterPanel minSize={17.5} className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">문서대량폐기 신청정보</span></h2>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th rowSpan={2} className="p-align-center p-x-frozen-last"><div className="p-column-header-content"><span className="p-column-title">직원명</span></div></th>
                ...
                <div className="m-footer">
                  <ul className="m-bullets type-disc">
                    <li>처리상태가 업체수거예정이 되면 수거업체가 1주(최대 4주) 이내 영업점 방문 예정입니다.</li>
                  </ul>
                </div>
            ...
            <SplitterPanel minSize={17.5} size={100 * 5 / 12} className="column _views">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h3 className="o-heading level3"><span className="label">신청기본정보</span></h3>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h3 className="o-heading level3"><span className="label">신청상세정보</span></h3>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">신청단위<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">인계자<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">폐기종류<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
                          </tr>
                        </thead>
