/**
 * @description 영업지원 > 토지보상우편물 > 토지보상우편물(본부)
 */
...
function BSSRM0201M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '영업지원' }, { label: '토지보상우편물' }, { label: '토지보상우편물(본부)' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">토지보상우편물(본부)</span>
          ...
          <div className="binds">
            ...
            <div className="m-binds type-end">
              ...
              <div className="group _primary">
                ...
                <CommonButton label="발송취소" className="_lined-primary" />
                <CommonButton label="발송" className="_solid-primary" />
              ...
              <div className="o-section">
                <div className="m-header">
                  <h3 className="o-heading level3">
                    <span className="label">토지보상 우편물 진행정보</span>
                  </h3>
                </div>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td colSpan={1}>
                            <div className="m-string-binds">
                              ...
                              <span className="binds"><CommonButton label="메모관리" className="_normal" /></span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td colSpan={3}>
                            <div className="m-inline-binds">
                                <CommonButton label="BPR 스캔정보 선택" className="_normal" />
                                <CommonButton label="BPR 조회" className="_normal" />
                            </div>
                          </td>

                          <th colSpan={1}>
                            <Label label={`발송일시`} require={false} />
                          </th>
                          <td colSpan={3}>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`이관부점`} require={false} />
                          </th>
                          <td colSpan={1}>
                          ...
                          <th colSpan={1}>
                            <Label label={`이관일자`} require={false} />
                          </th>
                          <td colSpan={1}>
                            <span className="o-digit type-date">2025-12-25</span>
                          </td>
                          ...
                          <th colSpan={1}>
                            <Label label={`이관직원`} require={false} />
                          </th>
                          <td colSpan={1}>
                            [081000] 홍길동
                          </td>
                          ...
                          <th colSpan={1}>
                            <Label label={`관련고객명`} require={false} />
                          </th>
                          <td colSpan={1}>
                            이기업
                          </td>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`우편물내용`} require={true} />
                          </th>
                          <td colSpan={3}>
                            <div className="o-field">
                              <div className="fields">
                          ...
                          <th colSpan={1}>
                            <Label label={`등기본등본 & 관리서류`} require={true} />
                          </th>
                          <td colSpan={3}>
