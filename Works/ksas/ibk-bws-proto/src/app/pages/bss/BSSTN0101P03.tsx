            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">채권양도통지 내역</span></h4>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">채권양도통지 실물인도 행내등기 신청정보</span></h5>
                </div>
                ...
                <div className="m-footer">
                  <ul className="m-bullets type-disc">
                    <li className="c-color-strong"><em>인수직원이 타 부점에 있는 경우가 있으니, 정확한 배송을 위해 인수직원의 부점정보를 확인하시기 바랍니다.</em></li>
                  </ul>
                </div>
