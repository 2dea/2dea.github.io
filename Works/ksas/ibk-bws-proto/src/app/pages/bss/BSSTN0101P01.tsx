/**
 * @description 행내등기·우편물 > 등기우편물 > 등기우편물관리대장 ~ (LP)등기번호등록
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">등기번호등록</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">엑셀 업로드</span></h4>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">관리번호<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">등기번호<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
                          </tr>
                          <tr>
                ...
                <div className="o-board type-a">
                  <div className="board-container">
                    ...
                    <ol className="m-bullets type-decimal level1">
                      <li>채권양도통지 내역을 엑셀다운로드 받아 등기번호를 입력하여 업로드하세요.</li>
                      <li className="c-color-strong">등록 시 관리번호, 등기번호는 필수값입니다.</li>
                      <li>등기번호 다건 수정을 원하는 경우 엑셀을 수정하여 재업로드하세요.</li>
                      <li>채권양도통지여부가 '통지완료'일 경우 등기번호 등록 및 수정이 불가능합니다.</li>
                    </ol>
                  </div>
                </div>
              </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)등기번호등록 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
