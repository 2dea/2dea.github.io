/**
 * @description 영업지원 > 캘린더신청 > 배송·인수관리 ~ (LP)인수증확인
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">인수증확인</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">신청수량</span></h4>
                </div>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">신청수량</span></div></th>
                          </tr>
                        </thead>
        ...
        <div className="div-footer">
          <div className="m-binds type-end">
            <div className="group _primary">
              ...
              <CommonButton label="출력" className="_solid-primary" />
            </div>
          </div>
        </div>
      </Dialog>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)인수증확인 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
