/**
 * @description 영업지원 > 연수원 > 연수원품목정보관리
 */
...
function BSSTI0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '영업지원' }, { label: '연수원' }, { label: '연수원품목정보관리' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">연수원품목정보관리</span>
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td colSpan={1}>
                            <div className="m-checks">
                              <InputRadio name="RADIO_10" label="비품" defaultChecked />
                              <InputRadio name="RADIO_10" label="소모품" />
                            </div>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td colSpan={1}>
                            <div className="m-checks">
                              <InputRadio name="RADIO_20" label="활동" defaultChecked />
                              <InputRadio name="RADIO_20" label="비활동" />
                            </div>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
                                <div className="o-form _input wdth-90 g-end">
                                  <InputText placeholder="" value={value} className="bind" onChange={(e) => setValue(e.target.value)} />
                                  <i aria-hidden="true"></i>
                                </div>
                              </div>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`단위당개수`} require={false} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
