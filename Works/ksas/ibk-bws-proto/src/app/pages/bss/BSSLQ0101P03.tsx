/**
 * @description 영업지원 > 대량신규  > 대량신규승인 ~ (LP)업무완료
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">업무완료</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">업무완료</span></h4>
                </div>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`업무완료일자`} require={true} />
                          </th>
                          <td colSpan={1}>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`승인자`} require={false} />
                          </th>
                          <td colSpan={1}>
                            [00001] 홍길동
                          </td>
                          <th colSpan={1}>
                            <Label label={`승인(반송)일자`} require={false} />
                          </th>
                          <td colSpan={1}>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">신청 상세내역</span></h4>
                </div>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th colSpan={1}>
                            <Label label={`신청제목`} require={false} />
                          </th>
                          <td colSpan={3}>
                            적립식통장 100건
                          </td>
                        ...
                        <tr>
                          ...
                          <th colSpan={1}>
                            <Label label={`사전협의자`} require={false} />
                          </th>
                          <td colSpan={1}>
                            [00001] 홍길동
                          </td>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`영엄점서류 발송일자`} require={false} />
                          </th>
                          <td colSpan={1}>
                            <span className="o-digit type-date">2025-12-25</span>
                          </td>
                          <th colSpan={1}>
                            <Label label={`영엄점수령 희망일자`} require={false} />
                          </th>
                          <td colSpan={1}>
                            <span className="o-digit type-date">2025-12-25</span>
                          </td>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">통장</span></h5>
                </div>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">기타요청사항</span></h5>
                </div>
                ...
                <div className="main">
                  <div className="o-field">
                    <div className="fields">
                      <div className="o-form _input">
                        <InputTextarea placeholder="내용을 입력해주세요" value={value} className="bind" onChange={(e) => setValue(e.target.value)} rows={2} cols={80} readOnly />
                        <i aria-hidden="true"></i>
                      </div>
                    </div>
                  </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)업무완료 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
