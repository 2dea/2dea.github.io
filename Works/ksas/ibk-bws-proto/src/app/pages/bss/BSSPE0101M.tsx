/**
 * @description 영업지원 > 제안서평가위원선정 > 제안서평가위원회생성
 */
...
function BSSPE0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '영업지원' }, { label: '제안서평가위원선정' }, { label: '제안서평가위원회생성' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">제안서평가위원회생성</span>
                  ...
                  <form className="m-data-form">
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`제안평가일시`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
                                <div className="o-form _input mode-required type-date wdth-50">
                                  <Calendar placeholder="" value={Date} locale="ko" dateFormat="yy-mm-dd" mask="9999-99-99" appendTo={document.body} className="bind" onChange={(e) => setDate(e.value)} showIcon icon={<Icon icon="calendar" />} />
                                  <i aria-hidden="true"></i>
                                </div>

                                <div className="o-form _input mode-required type-time wdth-30">
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`총 평가위원 수`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="o-field">
                              <div className="fields">
                        ...
                        <tr>
                          <th colSpan={1}>
                            <Label label={`부점별 평가위원 수`} require={true} />
                          </th>
                          <td colSpan={1}>
                            <div className="m-binds">
