/**
 * @description 영업지원 > 캘린더신청 > 배송·인수관리 ~ (LP)고객배송정보
 */
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">배송내역</span></h4>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)고객배송정보 [wdth-50p(w1340)]</span>
            </h1>
          </div>
        </div>
