/**
 * @description 공통·결재 > 대사관리 > 대금정산모니터링 ~ (LP)대금정산상세
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">대금정산상세</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                ...
                <div className="m-header">
                  <h3 className="o-heading level2"><span className="label">기본정보</span></h3>
                </div>
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td colSpan={1}>
                            <span className="o-digit type-date">2025</span>
                          </td>

                          <th colSpan={1}>
                            <Label label={`분기`} require={false} />
                          </th>
                          <td colSpan={1}>
                            1/4 분기
                          </td>
                          ...
                          <th colSpan={1}>
                            <Label label={`기준일자`} require={false} />
                          </th>
                          <td colSpan={1}>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h3 className="o-heading level2"><span className="label">작업후 대금정산 상세내역(인도/폐기/기타)</span></h3>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">자료생성구분</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">비목</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">본/영 구분</span></div></th>
                        ...
                        <tfoot className="p-datatable-tfoot sumtotal-tfoot">
                          <tr className="sumtotal-trow">
                            ...
                            <td className="sumtotal-tcell g-end">999,999</td>
                            <td className="sumtotal-tcell g-end">999,999</td>
                            <td className="sumtotal-tcell">정산대상금액</td>
                            <td className="sumtotal-tcell g-end">999,999</td>
                          </tr>
                        </tfoot> */}
                      </table>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)대금정산상세 [wdth-40p(w770)]</span>
            </h1>
          </div>
        </div>
