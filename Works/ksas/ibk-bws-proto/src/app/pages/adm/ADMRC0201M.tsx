/**
 * @description 공통·결재 > 대사관리 > 중요용지잔량대사
 */
...
function ADMRC0201M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '공통·결재' }, { label: '대사관리' }, { label: '중요용지잔량대사' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">중요용지잔량대사</span>
            ...
            <div className="column">
              ...
              <form className="m-filter-form">
                <div className="fieldset">
                  ...
                  <div className="o-field">
                    <Label label={`일련번호 비교`} require={false} />
                    <div className="fields">
                  ...
                  <div className="o-field">
                    <Label label={`수표류 포함`} require={false} />
                    <div className="fields">
                      <div className="m-checks">
                        <InputCheck label="선택" labelHidden />
                      </div>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">서버 호스트 잔량비교(수량 - TLIN)</span></h2>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          ...
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">출급명</span></div></th>
                        ...
                        <tbody className="p-datatable-tbody">
                          {[...Array(24)].map((e, idx) => (
                            <tr key={idx} className={`${idx === 0 ? 'p-highlight' : ''}`}>{/* 그리드 최초 진입시 첫번째 행 tr.p-highlight <$tr.trigger('click')> { @DEV } */}
                              ...
                              <td>001</td>
                              <td>1000791</td>
                              <td className="g-start">정액 10만원권자기앞수표</td>
                              <td className="g-end">30</td>
                              <td></td>
                              <td></td>
                              <td></td>
                              <td className="g-end">30</td>
                              <td className="g-end">130</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
