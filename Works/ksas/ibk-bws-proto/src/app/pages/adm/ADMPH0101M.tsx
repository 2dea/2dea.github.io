/**
 * @description 공통·결재 > 휴일관리 > 영업일/휴일등록
 */
...
function ADMPH0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '홈' }, { label: '공통·결재' }, { label: '휴일관리' }, { label: '영업일/휴일등록' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">영업일/휴일등록</span>
            ...
            <SplitterPanel minSize={17.5} className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">조회내역</span></h2>
                </div>
