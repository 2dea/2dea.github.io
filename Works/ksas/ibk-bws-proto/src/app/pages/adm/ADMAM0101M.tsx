/**
 * @description 공통·결재 > 알림관리 > 알림메시지관리
 */
...
function ADMAM0101M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '공통·결재' }, { label: '알림관리' }, { label: '알림메시지관리' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">알림메시지관리</span>
        ...
        <div className="div-contents">
          <div className="o-grid">
            <div className="column">
              ...
              <form className="m-filter-form">
                <div className="fieldset">
                  ...
                  <div className="o-field">
                    <Label label={`발송대상`} require={false} />
                  ...
                  <div className="o-field">
                    <Label label={`본부/영업점`} require={false} />
                    <div className="fields">
                      <div className="o-form _select">
                        <XDropdown appendTo={'self'} className="bind" />
                        <i aria-hidden="true"></i>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h4 className="o-heading level2"><span className="label">사용자목록</span></h4>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th rowSpan={2} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">직위</span></div></th>
                          </tr>
                          <tr>
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">발송대상</span></h5>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">발송정보</span></h5>
                </div>
          ...
          <div className="div-footer">
            <div className="m-binds type-end">
              <div className="group">
                <CommonButton label="알림수신제외등록" className="_lined-secondary" />
              </div>
