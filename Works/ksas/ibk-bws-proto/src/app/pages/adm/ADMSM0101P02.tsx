/**
 * @description 공통·결재 > 결재관리 > 결재내역관리 ~ (LP)대직자변경
 */
  ...
  return (
    <>
      <Dialog
        ...
        modal={true}
        // footer={<></>}
        header={<h3 className="o-heading"><span className="label">대직자변경</span></h3>}
      >
            ...
            <div className="column">
              ...
              <div className="o-section">
                <div className="m-header">
                  <h5 className="o-heading level3"><span className="label">결재선</span></h5>
                </div>

                <div className="main">
                  <div className="o-data-table type-approve case-choose">
                      ...
                      <table className="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td colSpan={1}>
                              <div className="o-approve is-selected">
                                <div className="main">
                                  <span className="approval">
                                    <span className="name">안정원</span>
                                    <span className="position">팀장</span>
              ...
              <div className="o-section">
                <div className="m-header">
                  <h6 className="o-heading level4"><span className="label">대직자변경</span></h6>
                </div>
        ...
        <div className="div-header">
          <div className="m-title">
            <h1 className="o-heading level1">
              <span className="label">(P)대직자변경 [wdth-60p(w1150)]</span>
            </h1>
          </div>
        </div>
