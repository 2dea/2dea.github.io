/**
 * @description 공통·결재 > 대사관리 > 중요용지재고입력
 */
...
function ADMRC0601M() {
  ...
  // BreadCrumb
  const paths: MenuItem[] = [{ label: '공통·결재' }, { label: '대사관리' }, { label: '중요용지재고입력' }];
          ...
          <div className="main">
            ...
            <div className="m-title">
              <h1 className="o-heading level1">
                <span className="label">중요용지재고입력</span>
        ...
        <div className="div-contents">
          <Splitter gutterSize={0} className="o-grid">
            <SplitterPanel minSize={17.5} size={100 * 5 / 12} className="column _views">
              ...
              <form className="m-filter-form">
                <div className="fieldset">
                  ...
                  <div className="o-field colspan-2">
                    <Label label={`부점`} require={true} append={
                      <>
                        <div className="binds type-tooltip">
                          <Tooltip className="o-tooltip" target="#ADMRC0601M-tooltip-10" position="top">
                            일반지점 서무계 재고만 저장 가능합니다.
                          </Tooltip>
                          <ImageButton id="ADMRC0601M-tooltip-10" label="툴팁​도움말" title="" icon="tooltip-help" className="g-cursor-help" />
                        </div>
                      </>
                    } />
              ...
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">현재재고내역</span></h2>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">현재재고</span></div></th>
                          </tr>
                        </thead>
                        ...
                        <tbody className="p-datatable-tbody">
                          {[...Array(24)].map((e, idx) => (
                            ...
                            >
                              <td>{idx + 1}</td>
                              <td>10412</td>
                              <td className="g-start">비정액 자기앞수표(1억원초과)</td>
            ...
            <SplitterPanel minSize={17.5} className="column">
              <div className="o-section">
                <div className="m-header">
                  <h2 className="o-heading level2"><span className="label">입력재고내역</span></h2>
                      ...
                      <table className="p-datatable-table p-datatable-scrollable-table">
                        ...
                        <thead className="p-datatable-thead">
                          <tr>
                            ...
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">출급번호</span></div></th>
                            <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">품목명</span></div></th>
                            <th colSpan={4} className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">중요용지일련번호<em className="o-require-tag"><span className="tag">(필수입력)</span></em></span></div></th>
