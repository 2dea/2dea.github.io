/**
 * @description 공통·결재 > 권한관리 > 생성관리 > (T)팝업관리
 */
  ...
  return (
    <>
      <div className="roles" data-div-role="0">
        ...
        {/* <!-- /* Contents { @DEV } --> */}
        <Tabs className="div-contents" defaultIndex={2}>
              ...
              <SplitterPanel minSize={17.5} className="column">
                ...
                <form className="m-filter-form">
                  <div className="fieldset">
                    ...
                    <div className="o-field">
                      <Label label={`팝업ID`} require={false} />
                ...
                <div className="o-section">
                  <div className="m-header">
                    <h2 className="o-heading level2"><span className="label">팝업내역</span></h2>
                        ...
                        <table className="p-datatable-table p-datatable-scrollable-table">
                          ...
                          <thead className="p-datatable-thead">
                            <tr>
                              ...
                              <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">팝업ID</span></div></th>
                              <th className="p-align-center"><div className="p-column-header-content"><span className="p-column-title">팝업명</span></div></th>
