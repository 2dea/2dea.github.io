/**
 * @description COHQ1010P01_03상시감시현황(본부영업점)_01보완요청현황_02상세_01본부영업점(재보완시)
 */
...
function COHQ1010P01_A() {
  // 모달
  const [visible, setVisible] = useState<boolean>(true);
  const footerContent = (
    <div className="u-modal-footer space">
      <Button label="저장" className="btn-text primary blue-line" onClick={() => setVisible(false)} />
      <Button label="재보완등록" className="btn-text primary blue-fill" onClick={() => setVisible(false)} autoFocus />
    </div>
  );
  ...
  return (
    ...
    >
      <div className="u-tag absolute t-28 l-138">
        <Tag severity="danger" value="중요도 고"></Tag>
        <Tag severity="warning" value="중요도 중"></Tag>
        <Tag severity="info" value="중요도 저"></Tag>
      </div>
                ...
                <div className="inner">
                  <div className="column f-14">
                    <dl className="u-dataview-list">
                      ...
                      <dd>
                        <div className="p-inputgroup clear">
                          <InputText value="결재를 추가해 보완해주세요" disabled />
                    ...
                    <dl className="u-dataview-list">
                      ...
                      <dd className="f-col">
                        <div className="flex">
                          <div className="p-inputgroup w-126">
                            <DatePicker />
                          </div>
                        </div>
                        <div className="p-inputgroup">
                          <InputTextarea
                            value="준법감시시스템(감사사후관리·부점보완요청목록)에서 보완기일 내 감리역(또는 담당 팀장) 및 부저장의 결재를 거쳐 보완완료"
