...
function Header() {
  ...
  return (
    <header className={`ibk-sys-header${isHovering ? ' ibk-sys-header-open' : ''}`}>
      <div className="inner">
        {/* logo */}
        <h1 className="logo">
          <Link to="/">
        ...
        {/* navi */}
        <nav className="gnb" onMouseOver={handleGnbMouseOver} onMouseOut={handleGnbMouseOut}>
          <div className="gnb-depth1">
            <NavLink to="/html/sulm1010m01" className={({ isActive }) => (isActive ? 'active' : '')}>
              상시감시실시(준법감시역)
            </NavLink>
            <NavLink to="/" className={({ isActive }) => (isActive ? 'active' : '')}>
              상시감시실시(준법지원역)
            </NavLink>
            <NavLink to="/html/COHQ1010M01" className={({ isActive }) => (isActive ? 'active' : '')}>
              상시감시현황(본부/영업점)
            </NavLink>
            <NavLink to="/html/UNAD1010M01" className={({ isActive }) => (isActive ? 'active' : '')}>
              통합관리
            </NavLink>
            <NavLink to="/html/LSA3010M01" className={({ isActive }) => (isActive ? 'active' : '')}>
              전자결재
            </NavLink>
            <NavLink to="/" className={({ isActive }) => (isActive ? 'active' : '')}>
              상시감시명령
            </NavLink>
            <NavLink to="/html/SYAD1030M01" className={({ isActive }) => (isActive ? 'active' : '')}>
              시스템관리
            </NavLink>
          </div>
          <div className="gnb-depth2" onMouseOut={handleGnbMouseOut}>
